...
const ProfileStackInfo = ({
  ...
  const portfolio = newUserProfile?.portfolio ? newUserProfile?.portfolio : ''
  useEffect(() => {
        ...
        <>
          ...
          <div className="personal-stack__portfolio portfolio">
            ...
            <label className="portfolio__label personal-stack__label">
              ...
              />
              {validationProfile(portfolio, 'portfolio')?.errorStatus ? (
                <div className="personal-stack__error">
                  {validationProfile(portfolio, 'portfolio')?.message}
                </div>
              ) : null}
            </label>
          </div>
